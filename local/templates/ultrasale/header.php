...
<header class="header">
        ...
        <div class="container">
            <div class="header-top__inner"><a class="header__logo" href="<?=SITE_DIR?>"><img src="<?=SITE_TEMPLATE_PATH?>/assets/images/svg/logo.svg" alt=""></a>
                ...
                <div class="header-top__right">
                    ...
                    <a class="header__stat" href="/compare/"><span class="header__cart-icon">
                        <span class="header__cart-icon">
                            <svg><use xlink:href="#stat"></use></svg></span>
                        </span>
                        <span class="header__cart-numb compare-numb">
                            <?$APPLICATION->IncludeComponent(
                    ...
                    <a class="header__fav" href="/favorites/">
                        <span class="header__cart-icon">
                            <svg><use xlink:href="#fav"></use></svg>
                        </span>
                        <span class="header__cart-numb"><?=countFavs();?></span>
                    </a>
                    <?
                    $APPLICATION->IncludeComponent(
                        "bitrix:sale.basket.basket.line",
    ...
    <?php
        if($APPLICATION->GetCurPage(false) == '/') echo '<div style="opacity: 0">';
        $APPLICATION->IncludeComponent(
            "bitrix:breadcrumb",
            "",
            array("START_FROM" => "0")
        );
        if($APPLICATION->GetCurPage(false) == '/') echo '</div>';
    ?>
</header>
