        ...
        <div class="container">
            <div class="header-bottom__inner">
                <div class="header__menu">
                    <ul>
                        <li class="drop cl"><a href="/catalog/">Каталог товаров</a><span class="arrow"><svg><use
                        ...
                        <li class="drop"><a href="/services/">Все услуги</a><span class="arrow"><svg><use
                                            xlink:href="#arrow"></use></svg></span>
                            <?php
                            $APPLICATION->IncludeComponent(
                            	"bitrix:menu",
                        ...
                        <li><a href="#">Системы кондиционирования</a></li>
                        <li><a href="#">Системы вентиляции</a></li>
                        <li><a href="#">Системы холодоснабжения</a></li>
                    </ul>
                </div>
