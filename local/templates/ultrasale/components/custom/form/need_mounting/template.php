<div class="modal fade call" id="need_mounting" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
            ...
            <div class="modal__text modal__text-call" id="form_<?= $arParams['TOKEN'] ?>">
                <div class="form__inner">
                    <div class="form__holder">
                        <div class="modal__text-title">Узнать стоимость монтажа</div>
