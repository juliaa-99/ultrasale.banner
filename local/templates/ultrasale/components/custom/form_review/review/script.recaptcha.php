        ...
        $(`#form_<?=$arParams['TOKEN']?> button`).click((e) => {
            ...
            if (validate) {
                grecaptcha.ready(async () => {
                    ...
                    data.append(`PREVIEW_TEXT`, $(`#form_<?=$arParams['TOKEN']?> *[name="text"]`).val())
                    data.append(`RATE`, $(`#form_<?=$arParams['TOKEN']?> *[name="rating"]:checked`).val())

                    if(sendsPhoto[0] != undefined) data.append(`PHOTO1`, sendsPhoto[0]);
                    if(sendsPhoto[1] != undefined) data.append(`PHOTO2`, sendsPhoto[1]);
                    if(sendsPhoto[2] != undefined) data.append(`PHOTO3`, sendsPhoto[2]);

                    data.append(`WARE`, $(`#form_<?=$arParams['TOKEN']?> *[name="product_id"]`).val())
