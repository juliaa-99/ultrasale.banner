...
$APPLICATION->AddChainItem("Избранное", "/fav/");
...
<?php } else {
    ...
    <div class="results-page">
        <div class="container">
            ...
            <div class="catalog-page__content-wrapper results" data-entity="<?= $containerName ?>">
                <!-- items-container -->
                <?php
                        ...
                        <div class="row" data-entity="items-row">
                            ...
                            foreach ($rowItems as $item) {
                                $APPLICATION->IncludeComponent(
                                    ...
                                    'catalog_fav',
                                    array(
                                        '~ADD_URL_TEMPLATE' => '/catalog/konditsionery/?action=ADD2BASKET&id=#ID#',
                                        'DISPLAY_COMPARE' => 'Y',
                                        'RESULT'          => array(
                                            'ITEM'                 => $item,
