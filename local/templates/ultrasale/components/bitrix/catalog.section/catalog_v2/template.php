...
<div class="catalog-page__content"> <? // wrapper ?>
    ...
    <? if (!empty($arResult['Tags'])) {?>
        <div class="catalog-page__content-tags">
            <? foreach ($arResult['Tags'] as $tag) {?>
            <a class="catalog-page__content-tags-item"
               href="<?=$arResult['SECTION_PAGE_URL']?>filter/brand-is-<?=$tag['CODE']?>/apply/"><?=$tag['NAME']?></a>
            <? } ?>
        </div>
    <? } ?>
    <div class="catalog-page__content-filter js-filter-mob"><img src="<?=SITE_TEMPLATE_PATH?>/assets/images/svg/filter.svg"
                                                                 alt=""><span>Фильтры</span></div>
    ...
    <div class="catalog-page__content-wrapper" data-entity="<?=$containerName?>">
			<!-- items-container -->
			<?php
		...
		{
			?>
			<div class="button-center" data-entity="lazy-<?=$containerName?>">
				<button type="button"
						class="button button-primary"
						data-use="show-more-<?=$navParams['NavNum']?>">
                    <span><?=$arParams['MESS_BTN_LAZY_LOAD']?></span>
				</button>
			</div>
			<?
		}
