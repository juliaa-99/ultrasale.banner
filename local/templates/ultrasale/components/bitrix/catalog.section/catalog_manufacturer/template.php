...
<div class="catalog-page__content"> <? // wrapper ?>
    <h1><?= $arParams['EXT_PAGE_NAME'] ?></h1>
    <? if (!empty($arParams['EXT_PAGE_PRE_TEXT'])) {?>
    <div class="catalog__more">
        <p><?=$arParams['EXT_PAGE_PRE_TEXT']?></p>
    ...
    //region Description
    if (!empty($arParams['EXT_PAGE_POST_TEXT']))
    {
        ?>
        <div class="catalog__more">
            <p><?= $arParams['EXT_PAGE_POST_TEXT'] ?></p>
            <div class="catalog__more-btn"><span class="op">Читать больше</span><span class="cl">Скрыть</span>
            </div>
        </div>
        <?
