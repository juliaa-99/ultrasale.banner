...
?>
<div class="smart-filter filter__in">
...
<?/*						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6
col-md-4<?else:?>col-12<?endif?> mb-2 smart-filter-parameters-box bx-active">
							<span class="smart-filter-container-modef"></span> */ ?>

                            <div class="filter__item open">
                            <div class="filter__title open">Цена</div>
                                <div class="smart-filter-slider-price-bar-vd" style="left: 0;right: 0; display: none
                                !important;" id="colorUnavailableActive_<?=$key?>"></div>
                                <div class="smart-filter-slider-price-bar-vn" style="left: 0;right: 0; display: none
                                !important;" id="colorAvailableInactive_<?=$key?>"></div>
                                <div class="smart-filter-slider-price-bar-v"  style="left: 0;right: 0; display: none
                                !important;" id="colorAvailableActive_<?=$key?>"></div>
                            <div class="filter__container" data-role="bx_filter_block">
                                <div class="filter__range polzunok-container-5">
                                    <div class="filter__range-item smart-filter-input-container">
                                        <input
                                    ...
                                    <div class="filter__range-item smart-filter-input-container">
                                        <input class="max-price polzunok-input-5-right" type="text"
                                    ...
                                    <div class="polzunok-5" data-min="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>"
                                         data-max="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>"
                                         data-min-current="<?=$arItem["VALUES"]["MIN"]["HTML_VALUE"]?>"
                                         data-max-current="<?=$arItem["VALUES"]["MAX"]["HTML_VALUE"]?>"
                                    ></div>
                                </div>
                            </div>
                            </div>
...
<? /*						</div> */ ?>
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="filter__item <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>open<?endif?>">
						<span class="smart-filter-container-modef"></span>

                            <div class="filter__title <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>open<?endif?>"><?=$arItem["NAME"]?></div>
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								<div class="filter__group-check">
										<?foreach($arItem["VALUES"] as $val => $ar):?>
											<div class="filter__check checkbox">
												<input
													type="checkbox"
													...
													onclick="smartFilter.click(this)"
												/>
												<label data-role="label_<?=$ar["CONTROL_ID"]?>" for="<? echo $ar["CONTROL_ID"] ?>" class="bx-filter-param-label ">
													<?=$ar["VALUE"];
													if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
														?>&nbsp;(<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
													endif;?>
            ...
            <div class="filter__btn">
                <button class="button button-primary" type="submit" id="set_filter" name="set_filter"><span>Применить</span></button>
                <a class="button button-tx" type="submit" id="del_filter" name="del_filter"><span>Сбросить
                        фильтр</span></a>
            </div>
