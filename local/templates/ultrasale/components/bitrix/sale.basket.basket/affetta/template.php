        ...
        <div class="cart-item__inner">
				<div class="mb-3 basket-items-list-wrapper basket-items-list-wrapper-height-fixed basket-items-list-wrapper-light<?=$displayModeClass?>"
					...
					<div class="basket-items-list-header" data-entity="basket-items-list-header">
						<div class="basket-items-search-field" data-entity="basket-filter" style="display: none;">
						...
						<div class="basket-items-list-header-filter">
							<span href="javascript:void(0)" class="cart-item__tt-h basket-items-list-header-filter-item
							active" data-entity="basket-items-count" data-filter="all" style="display: none;"></span>
							<span href="javascript:void(0)" class="basket-items-list-header-filter-item"
                               data-entity="basket-items-count" data-filter="similar" style="display: none;"></span>
							<span href="javascript:void(0)" class="basket-items-list-header-filter-item"
                               data-entity="basket-items-count" data-filter="warning" style="display: none;"></span>
							<span href="javascript:void(0)" class="basket-items-list-header-filter-item"
                               data-entity="basket-items-count" data-filter="delayed" style="display: none;"></span>
							<span href="javascript:void(0)" class="basket-items-list-header-filter-item"
                               data-entity="basket-items-count" data-filter="not-available" style="display: none;"></span>
						</div>
					</div>
                    <div class="catalog__item catalog__item-line top">
                        <div class="catalog__item-img"><span class="tt">товары</span></div>
                        <div class="catalog__item-title"></div>
                        <div class="catalog__item-price mob"><span class="tt">цена</span></div>
                        <div class="catalog__item-amount"><span class="tt">количество</span></div>
                        <div class="catalog__item-price"><span class="tt">сумма</span></div>
                    </div>
					<div class="basket-items-list-container" id="basket-items-list-container">
						...
						<div class="basket-items-list" id="basket-item-list">
							...
							<section class="basket-items-list-table" id="basket-item-table"></section>
						</div>
					</div>
				</div>
