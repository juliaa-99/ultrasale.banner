...
<div class="cart-product">
    <div class="container">
        ...
        if ($elementId > 0)
        {
            ...
            if (!empty($recommendedData) && false) /* INKODER Отключаем доп. товары */
            {
                ...
                if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N')
                {
                    ...
                    <div class='row'>
                        <div class='col-xs-12' data-entity="parent-container">
                            <div class="catalog-block-header" data-entity="header" data-showed="false" style="display: none; opacity: 0;">
                                <?=GetMessage('CATALOG_POPULAR_IN_SECTION')?>Популярные товары
                            </div>
                            <?
                            $APPLICATION->IncludeComponent(
                ...
                )
                {
                    ...
                    <div class='row'>
                        <div class='col-xs-12' data-entity="parent-container">
                            <div class="catalog-block-header" data-entity="header" data-showed="false" style="display: none; opacity: 0;">
                                <?=GetMessage('CATALOG_VIEWED')?>Просмотренные товары
                            </div>
                            <?
                            $APPLICATION->IncludeComponent(
