...
$filter_count = $GLOBALS['arFilter'];
unset($filter_count['FACET_INDEX']);
unset($filter_count['OFFERS']);
$filter_count = count($filter_count);
if($filter_count > 0){
    echo "<script>setFilterCount($filter_count);</script>";
}
				...
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box bx-active">
							...
							<div class="filter__title open" onclick="smartFilter.hideFilterProps(this)"><span><?=$arItem["NAME"]?> <!--<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>--></span></div>
							<div class="bx-filter-block" data-role="bx_filter_block">
								<div class="row bx-filter-parameters-box-container" style="width:calc(100% + 15px);">
                                    <div style="width:100%">
                                        <div class="col-xs-6 bx-filter-parameters-box-container-block bx-left">
                                            <!--<i class="bx-ft-sub">--><?//=GetMessage("CT_BCSF_FILTER_FROM")?><!--</i>-->
                                            <div class="bx-filter-input-container filter__range-item">
                                                <input
                                                    class="min-price"
                                                    type="text"
                                    ...
                                    <!--<i class="bx-ft-sub">--><?//=GetMessage("CT_BCSF_FILTER_TO")?><!--</i>-->
										<div class="bx-filter-input-container filter__range-item r">
											<input
												class="max-price"
												type="text"
...
//                    dump($arItem);
					...
					<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
						<div class="filter__title <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>open<?endif?>" onclick="smartFilter.hideFilterProps(this)">
...
<!--										<i class="bx-ft-sub">--><?//=GetMessage("CT_BCSF_FILTER_TO")?><!--</i>-->
								...
								default://CHECKBOXES
									?>
									<div class="col-xs-12 scrol-y-h-300px">
										<?foreach($arItem["VALUES"] as $val => $ar):?>
											<div class="checkbox">
