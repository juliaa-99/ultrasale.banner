...
if (Loader::includeModule('search'))
{
    ...
    ?>
        ...
        <div class="cart-item__tt-h">Результаты по запросу «<?=$_REQUEST["q"]?>»</div>
    <?php
	...
	{
		if (is_array($arElements) || trim($_REQUEST['q'] == ""))
		{
			?>
            </div>
            <div class="cart-page-nn tw">
                <div class="container">
                    <div class="cart-page-nn-inner">
                        <div class="cart-page-nn-img"><img src="<?=SITE_TEMPLATE_PATH?>/assets/images/cart-img-b2.png"
                                                           alt=""></div>
                        <div class="cart-page-nn-tt">
                            <div class="cart-page-nn-title">Ничего не найдено</div>
                            <div class="cart-page-nn-tx">Но у нас есть для вас кое-что интересное! <br>Попробуйте
                                изменить формулировку или воспользуйтесь нашим каталогом.</div><a class="button
                                button-primary" href="/catalog/"><span>Перейти в каталог</span></a>
                        </div>
                    </div>
                </div>
<?php
...
?>
    <div class="results__sh">
        <div class="header__search-in">
            <form action="" method="get">
              <input type="search" name="q" value="<?=$_REQUEST["q"]?>" />
              <? /* TODO INKODER Отключено, т.к. непонятен смысл
              <div class="header__search-product">
                <div class="header__search-product-item"><a class="header__search-product-img" href="#"><img src="assets/images/catalog-img2.jpg" alt=""></a><a class="header__search-product-title" href="#">Проточный электроводонагреватель Electrolux SMARTFIX 2.0 TS (5,5 kW) — кран+душ</a>
                  <div class="header__search-product-price">
                    <div class="header__search-product-price-now">18 200</div>
                    <div class="header__search-product-price-old">19 200</div>
                  </div>
                </div>
                <div class="header__search-product-item"><a class="header__search-product-img" href="#"><img src="assets/images/catalog-img2.jpg" alt=""></a><a class="header__search-product-title" href="#">Проточный электроводонагреватель Electrolux SMARTFIX 2.0 TS (5,5 kW) — кран+душ</a>
                  <div class="header__search-product-price">
                ...
                </div><a class="header__search-product-lnk" href="#">
