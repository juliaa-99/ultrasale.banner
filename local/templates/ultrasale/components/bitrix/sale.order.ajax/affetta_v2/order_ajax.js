			...
			else
			{
				BX.ajax({
					...
					onsuccess: BX.delegate(function(result) {
						...
						/**
						 * artem custom
						 * need for update mask on inputs before update frame (choose delivery...)
						 */
				        ...
				        if(!validateEmail($('#bx-soa-properties input[name=ORDER_PROP_3]').val())){
				           $('#bx-soa-properties input[name=ORDER_PROP_3]').css('border','1px solid red');
				        } else {
				            $('#bx-soa-properties input[name=ORDER_PROP_3]').css('border','1px solid rgba(169, 171, 189, 0.4)');
				        }
						// /artem custom
