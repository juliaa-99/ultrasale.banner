...
//            BX.remove(BX.lastChild(node));
    ...
    BX.Sale.OrderAjaxComponentExt.editDeliveryInfo = function(deliveryNode)
    {
        ...
        if (deliveryBlock.querySelector('.card-body-inner.tw').querySelector('.card-body-sh') !== null) {
            deliveryBlock.querySelector('.card-body-inner.tw').querySelector('.card-body-sh').remove();
        }

        var deliveryInfoContainer = BX.create('DIV', {props: {className: 'card-body-sh'}}),
        ...
        if (this.params.SHOW_DELIVERY_INFO_NAME == 'Y')
            subTitle = BX.create('DIV', {props: {className: 'card-body-sh-title'}, text: name});
 ...
 */
        title = BX.create('DIV', {
            ...
            children: [
                BX.create('DIV', {props: {className: ''}, html: currentDelivery.DESCRIPTION}),
                currentDelivery.CALCULATE_DESCRIPTION
                    ? BX.create('DIV', {props: {className: ''}, html: currentDelivery.CALCULATE_DESCRIPTION})
                    : null
            ]
        });
        ...
        deliveryBlock.querySelector('.card-body-inner.tw').appendChild(deliveryInfoContainer);
...
//        checked && BX.addClass(itemNode, 'bx-selected');
    ...
    BX.Sale.OrderAjaxComponentExt.editPaySystemInfo = function(paySystemNode)
    {
        ...
        let paysystemBlock =  document.querySelector('#bx-soa-paysystem');
        if (paysystemBlock.querySelector('.card-body-inner.tw').querySelector('.card-body-sh') !== null) {
            paysystemBlock.querySelector('.card-body-inner.tw').querySelector('.card-body-sh').remove();
        }

        var paySystemInfoContainer = BX.create('DIV', {
                props: {
                    className: 'card-body-sh'
                }
            }),
        ...
        if (currentPaySystem)
        {
            ...
            if (this.params.SHOW_PAY_SYSTEM_INFO_NAME == 'Y')
            {
                subTitle = BX.create('DIV', {
                    props: {className: 'card-body-sh-title'},
 ...
 */
            ...
            title = BX.create('DIV', {
                props: {className: 'bx-soa-pp-company-block'},
                children: [BX.create('P', {props: {className: 'bx-soa-pp-company-desc'}, html: currentPaySystem.DESCRIPTION})]
            });
            ...
            paySystemInfoContainer.appendChild(extPs);
        }
...
//        paySystemNode.appendChild(paySystemInfoContainer);
        paysystemBlock.querySelector('.card-body-inner.tw').appendChild(paySystemInfoContainer);
