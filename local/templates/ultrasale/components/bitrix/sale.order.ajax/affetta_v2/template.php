...
if ($request->get('ORDER_ID') <> '') {
    ...
    ?>
        <a href="/personal/cart/">Назад</a><br><br>
    <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM"
        ...
        <div id="bx-soa-order" class="row" style="opacity: 0">
            ...
            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 bx-soa">
            <? if ($arParams['BASKET_POSITION'] === 'before'): ?>
                <!--	BASKET ITEMS BLOCK	-->

                    <div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active card-body">
                        <div class="bx-soa-section-title-container d-flex justify-content-between align-items-center
                        flex-nowrap card-body">
                            <div class="bx-soa-section-title card-body-title" data-entity="section-title">
                                <div class="step"><span> 1</span></div>
                                <div class="title"><?= $arParams['MESS_BASKET_BLOCK_NAME'] ?></div>
                            </div>
                        </div>
                        <div class="bx-soa-section-content card-body-inner"></div>
                    </div>
            ...
            <? endif ?>
                ...
                <? else: ?>
                    <!--	DELIVERY BLOCK	-->
                    <div id="bx-soa-delivery" data-visited="false"
                         class="bx-soa-section bx-active card-body" <?= ($hideDelivery ? 'style="display:none"' : '') ?>>
                        <div class="bx-soa-section-title-container card-body">
                            <div class="bx-soa-section-title card-body-title" data-entity="section-title">
                                <div class="step"><span> 2</span></div>
                                <div class="title"><?= $arParams['MESS_DELIVERY_BLOCK_NAME'] ?></div>
                            </div>
                            <div class="card-body-inner tw">
                                <div class="bx-soa-section-content"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--	PAY SYSTEMS BLOCK	-->
                    <div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active card-body">
                        <div class="bx-soa-section-title-container card-body">
                            <div class="bx-soa-section-title card-body-title" data-entity="section-title">
                                <div class="step"><span> 3</span></div>
                                <div class="title"><?= $arParams['MESS_PAYMENT_BLOCK_NAME'] ?></div>
                            </div>
                            <div class="card-body-inner tw">
                                <div class="bx-soa-section-content"></div>
                            </div>
                ...
                <? endif ?>
                <!--	BUYER PROPS BLOCK	-->
                <div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active card-body">
                    <div class="bx-soa-section-title-container card-body">
                        <div class="bx-soa-section-title card-body-title" data-entity="section-title">
                            <div class="step"><span> 4</span></div>
                            <div class="title"><?= $arParams['MESS_BUYER_BLOCK_NAME'] ?></div>
                        </div>
                ...
                <!--	ORDER SAVE BLOCK	-->
                <div id="bx-soa-orderSave" class="cart-order__bt">
                    <div class="checkbox">
                        <?
                    ...
                    <button  style="margin: 10px 0"
                             class="button button-primary" data-save-button="true">
                        <span><?= $arParams['MESS_ORDER'] ?></span>
                    </button>
                    <div class="cart-order__bt-tx">Нажимая кнопку, я даю согласие на обработку своих персональных
                        данных в соответствии с <a href="#">Политикой конфиденциальности</a></div>
                </div>
            </div>
            <!--	SIDEBAR BLOCK	-->
            <div id="bx-soa-total" class="col-xl-4 col-lg-4 col-md-12 col-sm-12 bx-soa-sidebar ll">
                <div class="cart-order__total descr">
                    <div class="cart-order__total-tt">Детали заказа</div>
                    <div class="bx-soa-cart-total-ghost"></div>
                    <section class="js-cart-total bx-soa-cart-total"></section>
                </div>
            </div>
