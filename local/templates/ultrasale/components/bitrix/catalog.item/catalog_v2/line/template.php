...
?>
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 product-item-container" id="<?= $areaId ?>" data-entity="item">
    <div class="product-item catalog__item catalog__item-list">
        ...
        <div class="catalog__item-top">
            ...
            <div class="catalog__item-stock">
                ...
                <? } ?><br><br>
                <button class="btn btn-primary js-modal-query-price"
                ...
                <div class="catalog__item-table">
                    <div class="catalog__item-table-row">
                        <div class="catalog__item-table-cell"
                             data-code="BRAND">Производитель</div>
                        <div class="catalog__item-table-cell"><a class=""
                                                                 href="<?=$props['Brand']['SRC']?>"><?=$props['Brand']['NAME']?></a></div>
                    </div>
                    <?php
                    $counter = 4;
