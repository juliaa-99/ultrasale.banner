...
?>
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 product-item-container" id="<?= $areaId ?>" data-entity="item">
    <div class="product-item catalog__item">
        <div class="catalog__item-inf">
            <div class="catalog__item-fav active" data-id="<?=$item['ID']?>">
                <svg>
